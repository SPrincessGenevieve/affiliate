...
import { NetworkNode, NetworkUserDetail, useUserContext } from "@/app/context/UserContext";
        ...
        <div className="flex-shrink-0 w-3 flex justify-center pt-1">
          {hasChildren ? (
            <Image
              ...
              width={400}
              height={400}
              className={`w-3 h-auto transition-transform ${collapsed ? "rotate-0" : "rotate-90"}`}
            />
          ) : (
            <div className="w-3" />
          )}
